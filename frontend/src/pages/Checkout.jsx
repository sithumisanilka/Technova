  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        console.log("Checkout response received:", order);
        ...
        navigate("/products");
          ...
          console.log("Checkout request failed, but order might have been created:", checkoutError);

          // Even if the response times out, the order might have been created
          // Let's show a success message and clear the cart
          toast({
            title: "Order Submitted Successfully! 🎉",
            description: "Your order has been submitted and is being processed. You will receive a confirmation email shortly.",
          });
